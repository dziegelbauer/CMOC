        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RedundantWithId = table.Column<int>(type: "INTEGER", nullable: false),
                    ServiceRedundancyId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CAPABILITY_SUPPORT_RELATIONSHIPS_SERVICE_REDUNDANCIES_ServiceRedundancyId",
                        column: x => x.ServiceRedundancyId,
                        principalTable: "SERVICE_REDUNDANCIES",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "EquipmentServiceSupportRelationship",
                columns: table => new
                {
                    EquipmentId = table.Column<int>(type: "INTEGER", nullable: false),
                    RelationshipsId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipmentServiceSupportRelationship", x => new { x.EquipmentId, x.RelationshipsId });
                    table.ForeignKey(
                        name: "FK_EquipmentServiceSupportRelationship_EQUIPMENT_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "EQUIPMENT",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EquipmentServiceSupportRelationship_SERVICE_SUPPORT_RELATIONSHIPS_RelationshipsId",
                        column: x => x.RelationshipsId,
                        principalTable: "SERVICE_SUPPORT_RELATIONSHIPS",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CAPABILITY_SUPPORT_RELATIONSHIPS_ServiceRedundancyId",
                table: "CAPABILITY_SUPPORT_RELATIONSHIPS",
                column: "ServiceRedundancyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EquipmentServiceSupportRelationship_RelationshipsId",
                table: "EquipmentServiceSupportRelationship",
